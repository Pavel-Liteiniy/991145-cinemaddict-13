...
render(siteMainElement, new FilmsWrapperView(user));
...
render(siteFilmsWrapperElement, filmsCatalogComponent);
...
if (renderedFilms < films.length) {
  render(filmsCatalogComponent.getElement(), ShowButtonComponent);
